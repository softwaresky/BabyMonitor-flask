...
from BabyMonitor.models import Detections
...
class ThreadManager(threading.Thread):
    ...
    def __init__(self):
        ...
        self.motion_detector = motion_detector.MotionDetector(do_convert=True, do_record=self.do_record)
    ...
    def run(self):
        ...
        while True:
            ...
            if self.record_state:
                ...
                self.motion_detector.video_text = "Temp: {0} deg. C  | Hum: {1}%".format(dict_dht_data["temp"], dict_dht_data["hum"])
            ...
            if not is_merged and self.noise_detector.last_file and self.motion_detector.last_file and self.motion_detector.saved and self.noise_detector.saved:
